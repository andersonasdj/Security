package br.com.techgold.security.controller;
...
public class AppController {
	...
	@PreAuthorize("hasRole('ROLE_USER')")
	@GetMapping("/impressao-timesheet-cliente-legacy")
	public String impressaoTimeSheetClienteLegacy() {
		return "templates/impressao-timesheet-cliente-legacy.html";
	}
	...
	public String impressaoTimeSheetFuncionario() {
	 ...
	 @PreAuthorize("hasRole('ROLE_USER')")
	@GetMapping("/impressao-timesheet-funcionario-legacy")
	public String impressaoTimeSheetFuncionarioLegacy() {
		return "templates/impressao-timesheet-funcionario-legacy.html";
	}
